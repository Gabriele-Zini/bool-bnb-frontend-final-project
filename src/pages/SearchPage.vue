            ...
            <div class="col-4 text-center border border-2 p-3">
                <form @submit.prevent="fetchData()" action="" method="GET">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="postal_code" name="postal_code" v-model="postal_code" />
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="street_name" name="street_name" v-model="street_name" />
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="num_bed" name="num_bed" v-model="num_bed" />
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="mt_square" name="mt_square" v-model="mt_square" />
                    </div>
